...
class BkRecord extends Model
{
    ...
    protected $fillable = ['counselor_id', 'student_id', 'category_id', 'school_level', 'record_type', 'occurred_at', 'custom_topic', 'severity', 'chronology', 'action_taken', 'counseling_content', 'counseling_result', 'follow_up_plan', 'next_follow_up_at', 'status', 'status_updated_at', 'archived_at', 'archived_by'];
