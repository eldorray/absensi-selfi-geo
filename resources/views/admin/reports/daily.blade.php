<x-layouts.app>
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="admin-glass-panel bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="admin-muted text-sm text-gray-500 dark:text-gray-400">Jumlah Pegawai</p>
            ...
            <div class="admin-glass-panel bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="admin-muted text-sm text-gray-500 dark:text-gray-400">Sudah Absen Masuk</p>
            ...
            <div class="admin-glass-panel bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="admin-muted text-sm text-gray-500 dark:text-gray-400">Sudah Absen Pulang</p>
        ...
        <div class="text-center py-4">
            ...
            <p class="admin-muted text-gray-500 dark:text-gray-400">{{ $selectedDate->translatedFormat('l, d F Y') }}</p>
        </div>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($reportData as $index => $data)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td class="admin-muted px-4 py-3 text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3 text-center">
                                    @switch($data['status'])
                                        ...
                                        @case('no_schedule')
                                            <span
                                                class="admin-status-neutral px-2 py-1 text-xs font-semibold rounded-full bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300">
                                ...
                                <td class="px-4 py-3 text-right text-sm">
                                    @if ($data['fine'] > 0)
                                        ...
                                        <div class="admin-muted text-[10px] text-gray-400">telat {{ $data['late_minutes'] }} mnt</div>
                                    @else
                                        <span class="text-gray-400">-</span>
                                    @endif
                                </td>
