    ...
    <div class="space-y-6">
        ...
        <div class="admin-page-header flex items-center justify-between">
            <div>
                ...
                <p class="admin-muted mt-1 text-sm text-gray-600 dark:text-gray-400">Manajemen lokasi kantor untuk geofencing absensi</p>
            </div>
            <a href="{{ route('admin.offices.create') }}" class="admin-button-primary inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-xl transition-colors">
        ...
        <!-- Success Message -->
        @if(session('success'))
            <div class="admin-alert-success bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-xl p-4 flex items-center">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($offices as $office)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="admin-status-info px-3 py-1 text-sm font-medium bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200 rounded-full">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="{{ route('admin.offices.edit', $office) }}" class="admin-button-primary size-11 p-0 text-gray-600 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400 transition-colors">
                                        ...
                                        <form action="{{ route('admin.offices.destroy', $office) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus kantor ini?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="admin-button-danger size-11 p-0 text-gray-600 hover:text-red-600 dark:text-gray-400 dark:hover:text-red-400 transition-colors">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="admin-muted text-gray-400">
