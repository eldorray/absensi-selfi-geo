<x-layouts.mobile title="Riwayat Absen" activeTab="riwayat">
    <x-slot:headerAction>
        <span class="text-[9px] font-bold theme-text-muted font-outfit uppercase bg-white/5 border border-white/5 px-2.5 py-1 rounded-lg">
    ...
    <div class="space-y-3 pb-4">
        @forelse($attendances as $attendance)
            <div class="glass-card theme-border rounded-[22px] p-3.5 flex items-center gap-3.5 hover:scale-[1.01] transition-transform duration-300">
                <!-- Selfie Image Preview -->
                <div class="w-14 h-14 rounded-xl overflow-hidden flex-none bg-slate-900 border border-white/10 shadow-inner">
                ...
                <div class="flex-1 min-w-0 text-left">
                    <div class="flex items-center justify-between gap-2">
                        ...
                        <span class="px-2 py-0.5 text-[8px] font-black uppercase tracking-wider rounded-full flex-none @if($attendance->status->value === 'present') theme-status-ok-card theme-status-ok-text @else theme-status-late-card theme-status-late-text @endif">
        ...
        @empty
            ...
            <div class="rounded-3xl p-8 text-center glass-card theme-border">
                ...
                <h3 class="font-bold text-sm theme-text-main">Belum Ada Riwayat</h3>
