    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">
                <svg class="inline-block w-8 h-8 mr-2 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div x-data="attendanceForm()" x-init="init()" class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
                        <div class="bg-gradient-to-r from-green-500 to-emerald-700 px-6 py-4">
                        ...
                        <div class="p-6">
                            ...
                            <div class="relative bg-gray-900 rounded-xl overflow-hidden aspect-[4/3] mb-4">
                                ...
                                <div x-show="cameraLoading" class="absolute inset-0 flex items-center justify-center bg-gray-900">
                                    <div class="text-center">
                                        <svg class="animate-spin h-10 w-10 text-green-500 mx-auto mb-3" fill="none" viewBox="0 0 24 24">
                            ...
                            <div class="flex gap-3">
                                <button 
                                    ...
                                    class="flex-1 bg-green-600 hover:bg-green-700 disabled:bg-gray-400 text-white font-medium py-3 px-4 rounded-xl transition-colors flex items-center justify-center"
                                >
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"></path>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"></path>
                            ...
                            <form method="POST" action="{{ route('attendance.store') }}" @submit.prevent="submitForm">
                                ...
                                <div class="mb-6">
                                    ...
                                    <select 
                                        ...
                                        id="office_id"
                                        x-model="officeId"
                                        class="w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-green-500 focus:ring-green-500 py-3"
                                    >
